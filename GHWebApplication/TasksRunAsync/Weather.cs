...
namespace GHWebApplication.TasksRunAsync
{
    ...
    public partial class Weather
    {
        public static Weather FromJson(string json) =>
            JsonConvert.DeserializeObject<Weather>(json, GHWebApplication.TasksRunAsync.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Weather self) =>
            JsonConvert.SerializeObject(self, GHWebApplication.TasksRunAsync.Converter.Settings);
    }
